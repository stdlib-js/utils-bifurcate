...
```javascript
import bifurcate from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-bifurcate@v0.2.3-deno/mod.js';
```
...
[@stdlib/object/bifurcate-own]: https://github.com/stdlib-js/object-bifurcate-own/tree/deno
